...
def get_train():
    ...
    data_train = data_dev[0:5000]
    data_dev = data_dev[0:1000]
    ...
    train_qid_embeddings = get_embeddings(train_qid_list, dev_query2offset_dict, dev_query_embedding)  #(923,768)
